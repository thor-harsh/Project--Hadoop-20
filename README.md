...
**In this Project we will be using Spark SQL to create a dataframe instead of RDD. Here we will create dataframe directly from read.option instead of creating manually through RDD.<br>We will be performing various SQL operations on the dataframe.**
